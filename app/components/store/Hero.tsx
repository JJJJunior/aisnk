...
export async function Hero() {
  ...
  return (
    ...
    >
      ...
      <Link
        className="absolute bottom-12 text-xs md:text-lg left-6 lg:bottom-[80px] lg:left-[100px] bg-white text-blue-600 font-semibold px-2 py-2 md:px-4 md:py-4 shadow-sm rounded-lg hover:bg-blue-100"
