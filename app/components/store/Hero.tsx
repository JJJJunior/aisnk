...
export async function Hero() {
  ...
  return (
    <div
      className="w-full mx-auto px-2 h-[280px] md:h-[420px] bg-gradient-to-r from-indigo-500 via-sky-500 to-emerald-500 bg-[length:100%_200%] bg-[from-10%,via-30%,to-90%] rounded-2xl
     relative"
    >
      ...
      {res?.is_fake !== 1 && (
        <div className="absolute w-[200px] md:w-[400px] text-sm top-16 left-6 lg:left-[100px] lg:top-[120px] text-white md:text-3xl font-semibold">
      ...
      <Link
        className="absolute bottom-12 text-xs md:text-lg left-6 lg:bottom-[100px] lg:left-[100px] bg-white text-blue-600 font-semibold px-2 py-2 md:px-4 md:py-4 shadow-sm rounded-lg hover:bg-blue-100"
