  ...
  return (
    <div className="w-full mx-auto px-6 md:px-12 mt-12">
      <div className="flex justify-between items-center mb-2">
        <div className="md:text-2xl font-semibold text-gray-600">Picked For You</div>
        <Link
          ...
          newProducts.map((product) => (
            <div key={product.id} className="relative shadow-md rounded-lg mb-2 hover:shadow-lg bg-white">
              <Link href={`/web/products/${handleUrl(product as ProductType)}/${product?.id}`}>
                <div className="absolute bg-green-600 px-2 text-xs md:font-semibold text-white rounded-md ml-2 mt-2">
                  {product.tags}
                </div>
...
export default RecomendCollection;
